...
$user_role = [
    ...
    'author'      => esc_html__('Author', 'jnews-social-login'),
];
...
$options[] = [
	'id'              => 'jnews_option[social_login_redirect]',
	'option_type'     => 'option',
	'transport'       => 'postMessage',
	'default'         => '',
	'type'            => 'jnews-toggle',
	'section'         => 'jnews_social_login_section',
	'label'           => esc_html__( 'Previous Page Redirect', 'jnews-social-login' ),
	'description'     => esc_html__( 'Enable this option to redirect to the previous login page after social login.', 'jnews-social-login' ),
	'active_callback' => [
		[
			'setting'  => 'jnews_option[social_login_show]',
			'operator' => '!=',
