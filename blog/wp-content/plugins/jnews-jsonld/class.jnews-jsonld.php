		...
		if ( isset( $wp_query->post->ID ) ) {
			...
			if ( is_single() && get_post_type( $post_id ) === 'post' ) {
				...
				$single = array(
					...
					'dateCreated'      => get_the_date( 'Y-m-d H:i:s', $post ) . $timezone,
					'datePublished'    => get_the_date( 'Y-m-d H:i:s', $post ) . $timezone,
					'dateModified'     => get_post_modified_time( 'Y-m-d H:i:s', $post ) . $timezone,
